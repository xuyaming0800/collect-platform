											...
											$
													.ajax({
														...
														success : function(msg) {
															if (msg.code == 0) {
																location.href = "manager/frame.jsp";
															} else {
																$("#errorInfo")
																		.text(
																				msg.msg);
...
<body>
	...
	<div class="container col-sm-4 col-md-4 col-md-offset-4 col-sm-offset-4" id="loginDiv">
			...
			<h2 class="form-signin-heading" style="color:white" >数据联盟众包采集平台管理工具</h2>
			...
			<div class="input-group">
				<span class="input-group-addon">用户密码</span> <input type="password"
