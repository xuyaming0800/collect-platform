...
public class Test6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("attrs.xxx.attrs.xxx".substring(0,"attrs.xxx.attrs.xxx".lastIndexOf(".attrs"))+".attrList");
...
//		long g=a+600;
		//创建文件对象
        File file = new File("/Users/xuyaming/Downloads/bus_station.csv");
        File file_out = new File("/Users/xuyaming/Downloads/bus_station_out.sql");
        try {
...
//                    s[1]=s[1]+"-测试"+x;
    				...
    				String adcode = rs.getPointADCode(new Double(s[2]), new Double(s[3]));
    				CoordinateTransferEntity entity=new CoordinateTransferEntity();
         			...
         			entity.setX(new Double(s[2]));
         			entity.setY(new Double(s[3]));
         			double[] xy=new double[2];
         			CoordUtils.gcj2bd(entity.getX(), entity.getY(), xy);
         			s[2]=String.valueOf(xy[0]);
         			s[3]=String.valueOf(xy[1]);
...
//                    FileUtils.write(file_out,"\n","utf-8",true);
                    ...
                    FileUtils.write(file_out,"insert into demo_poi_bus values("+a+",'"+s[0]+"','"+s[0]+"',"+s[2]+","+s[3]+","+adcode+",0);","utf-8", true);
